...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.oauth_token) {
    ...
    this.khan.accessToken(oauthToken, oauthVerifier, callbackURL)
      .catch(function(err) {
      ...
      .then(function(res) {
        ...
        self.userProfile(token, tokenSecret, params, function(err, profile) {
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
  khan(token, tokenSecret)
    .user()
    .catch(function(err) { done(new InternalOAuthError('failed to fetch user profile', err)) })
